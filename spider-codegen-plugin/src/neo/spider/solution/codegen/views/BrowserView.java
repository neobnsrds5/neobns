...
public class BrowserView extends ViewPart  {
	...
	public String getContent() {
		...
		sb.append("<!doctype html>")
			...
			.append("<form>")
			.append("<div class=\"row align-items-center\"><label class=\"col col-form-label\" style=\"min-width: 164px; max-width: 164px; font-size: .875rem;\">데이터베이스 URL:</label>")
			.append("<div class=\"col\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"dbUrl\" name=\"dbUrl\" value=\"jdbc:mysql://localhost:3306/db2\"></div></div>")
			.append("<div class=\"row align-items-center\"><label class=\"col col-form-label\" style=\"min-width: 164px; max-width: 164px; font-size: .875rem;\">사용자명:</label>")
			.append("<div class=\"col\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"username\" name=\"username\" value=\"root\"></div></div>")
			.append("<div class=\"row align-items-center\"><label class=\"col col-form-label\" style=\"min-width: 164px; max-width: 164px; font-size: .875rem;\">비밀번호:</label>")
			.append("<div class=\"col\"><input class=\"form-control form-control-sm\" type=\"password\" id=\"password\" name=\"password\" value=\"1234\"></div></div>")
			.append("<div class=\"row align-items-center\"><label class=\"col col-form-label\" style=\"min-width: 164px; max-width: 164px; font-size: .875rem;\">저장할 폴더명:</label>")
			.append("<div class=\"col\"><input class=\"form-control form-control-sm\" type=\"text\" id=\"targetPath\" name=\"targetPath\" value=\"example\"></div></div>")
			.append("</form>")
			.append("<input class=\"btn btn-primary btn-sm\" type=\"button\" value=\"전체 테이블 조회\" onclick=\"listTables();\">")
