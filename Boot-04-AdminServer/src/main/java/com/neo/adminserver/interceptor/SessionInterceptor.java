package com.neo.adminserver.interceptor;
...
import com.neo.adminserver.service.AuthService;
...
public class SessionInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        System.out.println("Session Id: " + session.getAttribute("loginSessionId"));
        System.out.println("Session LoginYn: " + session.getAttribute("LOGIN_YN"));
