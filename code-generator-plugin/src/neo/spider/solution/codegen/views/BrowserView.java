...
public class BrowserView extends ViewPart  {
	...
	public String getContent() {
		...
		sb.append("<!doctype html>")
			...
			.append("<form>")
			.append("<label class=\"my-1\">데이터베이스 URL:</label><br>")
			.append("<input class=\"my-1 w-50\" type=\"text\" id=\"dbUrl\" name=\"dbUrl\" value=\"jdbc:mysql://localhost:3306/db2\"><br>")
			.append("<label class=\"my-1\">사용자명:</label><br>")
			.append("<input class=\"my-1 w-50\" type=\"text\" id=\"username\" name=\"username\" value=\"root\"><br>")
			.append("<label class=\"my-1\">비밀번호:</label><br>")
			.append("<input class=\"my-1 w-50\" type=\"password\" id=\"password\" name=\"password\" value=\"1234\"><br>")
			.append("<label class=\"my-1\">저장할 폴더명:</label><br>")
			.append("<input class=\"my-1 w-50\" type=\"text\" id=\"targetPath\" name=\"targetPath\" value=\"example\"><br>")
			.append("</form>")
			.append("<input class=\"btn btn-primary btn-sm my-2\" type=\"button\" value=\"전체 테이블 조회\" onclick=\"listTables();\">")
			.append("<div class=\"my-2\" id=\"tables\"></div>")
